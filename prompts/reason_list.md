...
For each medium or bad identifier, output a reason for why the identifier should be changed. Possible reasons are: uninformative, confusing, overly informative, language, syntactic.

Output in format "code line: identifier: quality: reason", one line for each identifier. Output nothing else.